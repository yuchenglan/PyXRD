...
plt.plot(x, int_lfilter + 1000, linewidth = 2, linestyle = '-', color = 'b', label = 'smoothened')

#legend etc of figure
#orginal data
plt.plot(x, y - 1000, label='raw data')
# detrended data
...
plt.plot(x, y_bg, color = 'k', label = 'remove background') # label='y - polynomial bg')
